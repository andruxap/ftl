...
!(function (o) {
	...
	var l,
		...
		i =
			(o("#navigation"),
			s.attr("data-navbar-base") ? s.attr("data-navbar-base") : ""),
	...
	function g(a) {
		...
		1200 <= u() &&
			...
			(l = (e / (t - o(window).height())) * 100),
			o(".scroll-progress .progress").css("height", l + "%"));
	}
	function h() {
		...
		a.off("click"),
			a.on("click", function (a) {
				...
				n.hasClass("ln-fullpage-active")
					? ((e = e.substr(1)), o.fn.fullpage.moveTo(e))
					: ((o(this).parents("li").attr("data-menuanchor") ||
							0 < o('[data-anchor="' + e.substr(1) + '"]').length) &&
							(e = o('[data-anchor="' + e.substr(1) + '"]')),
					  o.smoothScroll({
							offset: 0,
							easing: "swing",
							speed: 800,
			...
			e.on("hidden.bs.collapse", function () {
				s.removeClass("navbar-toggled-show"),
					s.hasClass("scrolled") ? b("scrolled") : b();
			}),
			o(document).on("click touchstart", function (a) {
				o(".site-navbar").is(a.target) ||
					...
					("true" === t.attr("aria-expanded") && t.trigger("click"));
			});
	}
	function b(a, e) {
		var t;
		(l === a && "" != a && null != a && "section" !== a) ||
			("toggled" === a && r
				? s.removeClass("navbar-light navbar-dark", i, c).addClass(r)
				: "scrolled" === a && c
				? s.removeClass("navbar-light navbar-dark", i, r).addClass(c)
				: "section" === a
				? (t = e.attr("data-navbar"))
					? s.removeClass("navbar-light navbar-dark", i, r, c).addClass(t)
					: s.removeClass("navbar-light navbar-dark", r, c).addClass(i)
				: i && s.removeClass("navbar-light navbar-dark", r, c).addClass(i),
			s.hasClass("navbar-light")
		...
		o(document).ready(function (a) {
			...
			a("html, body").scrollTop(0),
				...
				o("[data-gradient-bg]").each(function (a, e) {
					var t = o(this),
						l = "granim-" + a,
						s = (s = (s = t.attr("data-gradient-bg")).replace(" ", "")).replace(
							/'/g,
							'"'
						);
					...
					new Granim({
						...
						states: { "default-state": { gradients: s } },
					});
				}),
				(function () {
					if (
				...
				0 < (t = o(".countdown[data-countdown]")).length &&
					t.each(function () {
						var e = o(this),
							a = e.data("countdown");
				...
				(function () {
					...
					if (
						(1200 <= u() &&
							...
							t.attr("aria-expanded", "false").addClass("collapsed")),
						0 < a)
					)
						s.addClass("scrolled"),
							s.removeClass("scrolled-0"),
							s.hasClass("navbar-toggled-show") ? b("toggled") : b("scrolled");
					else if (
						(s.removeClass("scrolled"),
						s.addClass("scrolled-0"),
						s.hasClass("navbar-toggled-show"))
					)
						b("toggled");
					else {
				...
				(function () {
					...
					if (!n.hasClass("ln-fullpage-active"))
						if (0 < a) {
							...
							s.removeClass("scrolled"),
								s.addClass("scrolled-0"),
								s.hasClass("navbar-toggled-show") ? b("toggled") : b();
				})();
		});
})(jQuery);
